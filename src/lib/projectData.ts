export const projects = [
  {
    ...
    description: `UI 설계 및 재사용 가능한 캘린더/통계 컴포넌트 개발
  ...
  // },
  {
    ...
    summary: '알고리즘 학습을 위한 웹 플랫폼으로 문제 풀이 및 해설 제공',
     description: `알고리즘 문제 CRUD 및 풀이 히스토리 기능 개발
  ...
  },
  {
    ...
    description: `Vue 기반 동적 필터링 인터페이스 구성
    ...
    images: ['socrates1.png', 'socrates2.png'],
